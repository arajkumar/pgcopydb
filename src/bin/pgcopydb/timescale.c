...
bool
timescale_is_chunk(char *nspname_in, char *relname_in)
{
...
bool
timescale_allow_statement(char *nspname_in, char *relname_in)
{
	return !streq(nspname_in, "_timescaledb_catalog");
}
